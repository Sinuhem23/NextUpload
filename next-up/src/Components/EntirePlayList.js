...
import '../CSS/entireplaylist.css';

function entirePlayList() {
  return (
    <div>
      {/* -- Entire Playlist Section -- */}

      <div className='entire_uploads container_scroll'>
      ...
      {/* -- End of Entire Playlist Section -- */}
      {/* -- Entire Car Playlist Section -- */}
      ...
      {/* -- End of Car Playist SAection -- */}

      {/* -- Entire Motorcycle Playlist Section -- */}

      <div className='entire_uploads container_scroll'>
        <h3>Motorcycle Playlists</h3>
        <div className='recently_added_playlist_videos'>
          <div>
            <iframe
      ...
      {/* -- End of Motorcycle Playlist Section -- */}

      {/* -- Airplane Playlist Section -- */}

      <div className='entire_uploads container_scroll'>
        <h3>Airplane Playlists</h3>
        <div className='recently_added_playlist_videos'>
          <div>
            <iframe
              src='https://www.youtube.com/embed/XP_--KthFMI'
      ...
      {/* -- End of Airplane Playlist Section -- */}
      {/* -- Boat Playlist Section -- */}

      <div className='entire_uploads container_scroll'>
        <h3>Boat Playlists</h3>
        <div className='recently_added_playlist_videos'>
          <div>
            <iframe
